package com.bigdataxhy.data.aop;

import com.alibaba.fastjson.JSON;
import com.bigdataxhy.core.utils.RequestUtils;
import com.bigdataxhy.data.common.constants.LogConstant;
...
public class ControllerLogAspect extends MethodLogAspect {
    ...
    private String getLogMap(Object response, String methodName, String url, Object request, Object requestHeaders,
        ...
        // 执行API接口所耗费的时间
        map.put(LogConstant.KEY_API_COST_TIME, getCostTime(startTime, endTime));
        // 请求的URL
        map.put(LogConstant.KEY_API, url);
        // 请求的方法
        map.put(LogConstant.KEY_METHOD, methodName);
        // 请求的参数
        map.put(LogConstant.KEY_REQUEST, request);
        // 请求头
        map.put(LogConstant.KEY_REQUEST_HEADER, requestHeaders);
        // 返回的结果
        map.put(LogConstant.KEY_RESPONSE, response);
